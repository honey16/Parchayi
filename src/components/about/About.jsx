...
const About = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-16">
      ...
      <div className="flex flex-col  lg:flex-row gap-16 justify-center items-center">
        <div className="lg:w-1/2 lg:pl-24 px-20" ref={textRef}>
          <div className="space-y-6 font-bodytext text-gray-800">
            ...
            <p className="leading-relaxed">
              With regular photowalks, workshops, exhibitions, and contests,
              Prism provides members with hands-on experience and opportunities
              to showcase their talent. The society explores a wide range of
              photography styles, from portrait and wildlife to conceptual and
              street photography, while also delving into the art of
      ...
      <Stats />
      <TeamSection />
      <div className="bg-black text-white py-20 mt-16 font-bodytext rounded-lg">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <button className="bg-orange text-black py-3 px-16 text-lg font-medium">
            Join
          </button>
        </div>
      </div>
